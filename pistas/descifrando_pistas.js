...
const datosFiltrados = mockData.filter(
  (element) => element.last_name === "Nuwe"
);
...
const terceraPista = datosSinMascota.reduce(
  (accumulator, currentValue) =>
    Math.max(accumulator, currentValue.ip.split(".")[0]),
  0
);
